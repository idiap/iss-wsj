...
export HMM_TRAIN_DIR=../train-plp-si-84
...
export WORD_MLF=../local/si-84-list-trn.mlf
export FILE_LIST=../local/si-84-list-trn.txt
...
export WORD_MLF=../local/si-84-list-dev.mlf
export FILE_LIST=../local/si-84-list-dev.txt
...
export WORD_MLF=../local/h2_p0-list-tst.mlf
export FILE_LIST=../local/h2_p0-list-tst.txt
